...
\toprule
& \multicolumn{2}{c|}{AUC} & \multicolumn{2}{c}{Accuracy} \\
  Experiment & MFCC & GTCC & MFCC & GTCC \\ [0.5ex]
\midrule
...
the most accurate SVM model in both AUC and accuracy for both feature
representations. The highest performing of the CNN models is model 3, but it
should be noted that it takes significantly longer to train model 3 compared to
