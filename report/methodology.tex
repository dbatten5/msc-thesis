...
Frames are first windowed using a Hanning window, which minimizes the effects of
...
syllables to capture sufficient information about the vocalization. The fixed
...
with 133.3 Hz separating their center frequencies, and 27 log-spaced filters,
...
the center frequencies are closer together at higher frequencies and further
...
minimizing the classification error. This corresponds to the constant $C$ in
...
options that describe hyperparameters such as the mini-batch size and the optimizing
