...
its performance can be superior to the other method proposed. The algorithm is
computed in the following 3 phases:
...
\textit{MATLAB} can receive sequential data in different input formats, such as
